...
const AppLayout = ({ children }) => {
  return (
    <>
      <MetaTags />
      <div className="min-h-screen bg-indigo-100 flex flex-col justify-center py-12 px-6 lg:px-8">
        <div className="mb-6 text-center sm:mx-auto sm:w-full sm:max-w-md">
          ...
          <h1 className="mt-4 text-3xl font-extrabold text-gray-900">
            Redwood Ethereum Wallet Auth
          </h1>
          <p className="mt-2 text-sm text-gray-600 max-w">
            This page demonstrates authentication providers supported by Auth0 and SIWE
            <a
